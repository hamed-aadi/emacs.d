...
;; (global-set-key (kbd "<apps>") 'hmd-mode)
...
(define-key hmd-mode-map (kbd "g j")	'beginning-of-line)
...
(define-key hmd-mode-map (kbd "SPC v") 'yank-from-kill-ring)
...
(define-key hmd-mode-map (kbd "d k") (lambda ()	(interactive)
																			 (progn
